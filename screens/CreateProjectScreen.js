...
import { FONTS, COLORS, UTILITIES } from '../assets/constants/index';
...
const CreateProjectScreen = ({ navigation }) => {
  ...
  const [jobBudgetTo, setJobBudgetTo] = useState('');
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={{ marginTop: 30, paddingHorizontal: 20 }} showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        <View>
        ...
        <View style={UTILITIES.inputContainer}>
          ...
          <TextInput
            ...
            type="text"
            value={jobTags}
            onChange={e => setJobTags(e.nativeEvent.text)}
          />
        </View>
        ...
        <View style={UTILITIES.inputContainer}>
          ...
          <View style={[UTILITIES.inputField, { height: 65 }]}>
            <View style={styles.fromContainer}>
              <Text style={{ fontFamily: 'Roboto-Light', marginBottom: 3 }}>Start Date:</Text>
              <TouchableOpacity onPress={() => togglePicker('start')}>
                <Text style={styles.date}>{dayjs(startDate).format('MM/DD/YYYY')}</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.toContainer}>
              ...
              <TouchableOpacity onPress={() => togglePicker('end')}>
                <Text style={styles.date}>{dayjs(endDate).format('MM/DD/YYYY')}</Text>
              </TouchableOpacity>
            </View>
            <Modal
              ...
              <View style={styles.modalContainer}>
                <View style={styles.pickerContainer}>
                  ...
                  />
                  <Button title="Close" onPress={() => setShowStartDatePicker(false)} />
                </View>
              </View>
            </Modal>
            ...
            <Modal
              ...
              <View style={styles.modalContainer}>
                <View style={styles.pickerContainer}>
                  ...
                  />
                  <Button title="Close" onPress={() => setShowEndDatePicker(false)} />
                </View>
              </View>
            </Modal>
          </View>
        ...
        <View style={UTILITIES.inputContainer}>
          <View style={[UTILITIES.inputField, { height: 80 }]}>
            <TouchableOpacity onPress={_pickDocument}>
              <FontAwesome name="cloud-upload" size={38} color="black" style={styles.uploadLogo} />
